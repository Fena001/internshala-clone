...
const index = () => {
  ...
  useEffect(()=>{
    const fetchdata=async()=>{
      try {
        const res=await axios.get( "https://internshala-clone-ydgs.onrender.com/api/internship")     
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-gray-700">{t("WFH")}</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
