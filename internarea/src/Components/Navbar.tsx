...
const Navbar = () => {
  ...
  const handlelogin = async () => {
    ...
    try {
      ...
      try {
        await axios.post("https://internshala-0g4g.onrender.com/api/auth/log-oauth-login", {
          uid: result.user.uid,
  ...
  const handleCustomLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post("https://internshala-0g4g.onrender.com/api/auth/login", {
        type: "email",
        value: loginEmail,
  ...
  const verifyLoginOtp = async () => {
    ...
    setIsCustomLoggingIn(true);
    try {
      const res = await axios.post("https://internshala-0g4g.onrender.com/api/auth/verify-login-otp", {
  ...
  const sendOtp = async () => {
    ...
    try {
      const res = await axios.post("https://internshala-0g4g.onrender.com/api/otp/send-otp", { email: user.email });
      if (res.data.success) {
        setOtpSent(true);
  ...
  const verifyOtp = async () => {
    ...
    setIsLoadingOtp(true);
    try {
      const res = await axios.post("https://internshala-0g4g.onrender.com/api/otp/verify-otp", {
        email: user.email,
        otp: otpInput
      });
      if (res.data.success) {
